...
const DeleteRescueTeamDialog = ({
    ...
    const district = team?.district || "Unknown District";
            ...
            >
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5 sm:px-8">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h2 id="delete-team-dialog-title" className="text-2xl font-semibold tracking-tight text-slate-900">
                                Disband Rescue Team
                            </h2>
                            <p className="mt-1 text-sm text-slate-500">
                                Are you sure you want to permanently disband this rescue team?
                            </p>
                        </div>
                    </div>
                ...
                <div className="space-y-5 px-6 py-6 sm:px-8">
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
                            <div>
                                ...
                                <div className="mt-2 font-semibold text-slate-900">{teamName}</div>
                            </div>
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                                    Active Members
                                </div>
                                <div className="mt-2 font-semibold text-slate-900">{membersCount} members</div>
                            </div>
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                                    District
                    ...
                    <p className="text-sm text-slate-700">
                        This action will release all team members. Assumed vehicles and incident linkages for this team will be unlinked.
                    </p>
                </div>
...
export default DeleteRescueTeamDialog;
