...
const MODAL_FORM_ID = "rescue-team-modal-form";

const RescueTeamModal = ({
    isOpen,
    onClose,
    onSubmit,
    initialData,
    ...
    const title = mode === "add" ? "Create Rescue Team" : "Edit Rescue Team";
    const submitLabel = mode === "add" ? "Create Team" : "Save Changes";
    ...
    return (
        ...
        >
            ...
            <div
                ...
                role="dialog"
                aria-modal="true"
                aria-labelledby="rescue-team-modal-title"
            ...
            >
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5 sm:px-8">
                    <div>
                        <h2 id="rescue-team-modal-title" className="text-2xl font-semibold tracking-tight text-slate-900">
                            {title}
                        </h2>
                        <p className="mt-1 text-sm text-slate-500">
                            Configure rescue team members, leader, vehicle, and incident assignment.
                        </p>
                    </div>
...
export default RescueTeamModal;
