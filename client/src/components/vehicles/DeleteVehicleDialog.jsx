...
const DeleteVehicleDialog = ({
    ...
    const vehicleNumber = vehicle?.vehicleNumber || "Unknown Vehicle";
    const vehicleType = vehicle?.vehicleType || "Unknown Type";
    const district = vehicle?.district || "Unknown District";
            ...
            >
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5 sm:px-8">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h2 id="delete-vehicle-dialog-title" className="text-2xl font-semibold tracking-tight text-slate-900">
                                Decommission Vehicle
                            </h2>
                            <p className="mt-1 text-sm text-slate-500">
                                Are you sure you want to permanently decommission this rescue vehicle?
                            </p>
                        </div>
                    </div>
                ...
                <div className="space-y-5 px-6 py-6 sm:px-8">
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-3">
                            <div>
                                ...
                                <div className="mt-2 font-semibold text-slate-900">{vehicleNumber}</div>
                            </div>
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                                    Type
                                </div>
                                <div className="mt-2 font-semibold text-slate-900">{vehicleType}</div>
                            </div>
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                                    District
                    ...
                    <p className="text-sm text-slate-700">
                        This actions cannot be undone and will delete the vehicle record permanently.
                    </p>
                </div>
                ...
                <div className="flex flex-col-reverse gap-3 border-t border-slate-200 px-6 py-5 sm:flex-row sm:justify-end sm:px-8">
                    ...
                    >
                        {loading ? "Decommissioning..." : "Decommission Vehicle"}
                    </button>
                </div>
            </div>
        </div>
