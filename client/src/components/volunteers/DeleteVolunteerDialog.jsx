...
const DeleteVolunteerDialog = ({
    ...
    const fullName = volunteer?.fullName || "Unnamed Volunteer";
    const team = volunteer?.team || "No Team Assigned";
    const district = volunteer?.district || "Unknown District";
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-6">
            ...
            <div
                ...
                className="relative z-10 w-full max-w-lg animate-[fadeIn_180ms_ease-out] rounded-3xl border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.22)]"
            ...
            >
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5 sm:px-8">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h2 id="delete-volunteer-dialog-title" className="text-2xl font-semibold tracking-tight text-slate-900">
                                Remove Volunteer
                            </h2>
                            <p className="mt-1 text-sm text-slate-500">
                                Are you sure you want to permanently delete this volunteer record?
                            </p>
                        </div>
                    </div>
                ...
                <div className="space-y-5 px-6 py-6 sm:px-8">
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
                            <div>
                                ...
                                <div className="mt-2 font-semibold text-slate-900">{fullName}</div>
                            </div>
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                                    Rescue Team
                                </div>
                                <div className="mt-2 font-semibold text-slate-900">{team}</div>
                            </div>
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">
                                    District
                    ...
                    <p className="text-sm text-slate-700">
                        This action cannot be undone. All assignment history for this volunteer will be lost.
                    </p>
                </div>
                ...
                <div className="flex flex-col-reverse gap-3 border-t border-slate-200 px-6 py-5 sm:flex-row sm:justify-end sm:px-8">
                    ...
                    >
                        {loading ? "Deleting..." : "Delete Volunteer"}
                    </button>
                </div>
            </div>
        </div>
