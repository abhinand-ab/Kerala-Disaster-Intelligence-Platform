...
const MODAL_FORM_ID = "volunteer-modal-form";
...
const VolunteerModal = ({
    ...
    const title = mode === "add" ? "Add Volunteer" : "Edit Volunteer";
    const submitLabel = mode === "add" ? "Add Volunteer" : "Save Changes";
        ...
        >
            ...
            >
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5 sm:px-8">
                    <div>
                        <h2 id="volunteer-modal-title" className="text-2xl font-semibold tracking-tight text-slate-900">
                            {title}
                        </h2>
                        <p className="mt-1 text-sm text-slate-500">
                            Manage rescue volunteer and team details.
                        </p>
                    </div>
